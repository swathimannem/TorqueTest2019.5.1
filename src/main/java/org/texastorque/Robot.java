...
// 			transRotTempX0 = transX*0.3 + rotMag*Math.cos(Math.PI/4);
// 			transRotTempY0 = transY*0.3 + rotMag*Math.sin(Math.PI/4);
// 			transTheta0 = Math.toDegrees(Math.atan2(transRotTempY0, transRotTempX0));
// 			resultMag0 = Math.hypot(transRotTempX0, transRotTempY0);

// 			transRotTempX1 = transX*0.3 + rotMag*Math.cos(Math.PI/4);
// 			transRotTempY1 = transY*0.3 - rotMag*Math.sin(Math.PI/4);
...
// 			transRotTempX2 = transX*0.3 - rotMag*Math.cos(Math.PI/4);
// 			transRotTempY2 = transY*0.3 + rotMag*Math.sin(Math.PI/4);
...
// 			transRotTempX3 = transX*0.3 - rotMag*Math.cos(Math.PI/4);
// 			transRotTempY3 = transY*0.3 - rotMag*Math.sin(Math.PI/4);
...
// 			transRotTempY2 = transY*0.3 - rotMag*Math.sin(Math.PI/4);
// 			transTheta2 = Math.toDegrees(Math.atan2(transRotTempY2, transRotTempX2));
// 			SmartDashboard.putNumber("tempDiff2", transTheta2);
...
// 		SmartDashboard.putNumber("X_input", transX);
// 		SmartDashboard.putNumber("Y_input", transY);
// 		SmartDashboard.putNumber("Rot_input", rotMag);
// 		SmartDashboard.putNumber("Mag0_calculated", resultMag0);
// 		SmartDashboard.putNumber("Mag1_calculated", resultMag1);
// 		SmartDashboard.putNumber("Mag2_calculated", resultMag2);
// 		SmartDashboard.putNumber("Mag3_calculated", resultMag3);
// 		SmartDashboard.putNumber("Theta0_calculated", transTheta0);
// 		SmartDashboard.putNumber("Theta1_calculated", transTheta1);
// 		SmartDashboard.putNumber("Theta2_calculated", transTheta2);
// 		SmartDashboard.putNumber("Theta3_calculated", transTheta3);
// 		// today
